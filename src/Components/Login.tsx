    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen relative">
            ...
            <div className="w-full h-full flex items-center justify-center">
                <div className="w-full sm:w-5/6 max-w-screen-xl flex flex-col h-5/6 pc:h-fit lg:w-4/6 xl:w-4/6 py-10 rounded-xl bg-gradient-to-br from-custom-black from-50% to-custom-gold z-10 to-95% gap-y-2">
                    <div className='flex flex-col w-full xs:p-10 p-5 py-10' >
                        ...
                        <form className="space-y-5 w-full">
                            <div className='w-full'>
                                <label htmlFor="username" className='text-xl 2xs:text-xl xs:text-xl md:text-2xl 2xl:text-3xl text-neutral-600 teko-secondary'>Username</label>
                        ...
                        <div className='flex flex-row mt-5 gap-x-2'>
                            ...
                            <a href="" className='text-xl 2xs:text-xl xs:text-xl md:text-2xl 2xl:text-3xl text-custom-gold teko-secondary underline'>Cria Uma!</a>
                        </div>
                        ...
                        <div className='flex flex-row w-full justify-evenly gap-x-2'>
                            <button className='w-1/3 h-16 md:w-44 2xl:w-64 2xl:h-24 bg-white rounded-lg border-white border-2 '>
                                <a href="#" className='text-white text-xl md:text-2xl 2xl:text-4xl font-semibold flex items-center justify-center'>
                                    <img src="google.svg" alt="" className='w-2/6 max-h-12' />
                                </a>
                            </button>
                            <button className='w-1/3 h-16 md:w-44 2xl:w-64 2xl:h-24 bg-white rounded-lg border-white border-2 '>
                                <a href="#" className='text-white text-xl md:text-2xl 2xl:text-4xl font-semibold flex items-center justify-center'><img src="facebook.svg" alt="" className='w-2/6 max-h-12' /></a>
                            </button>
                            <button className='w-1/3 h-16 md:w-44 2xl:w-64 2xl:h-24 bg-white rounded-lg border-white border-2 '>
                                <a href="#" className='text-white text-xl md:text-2xl 2xl:text-4xl font-semibold flex items-center justify-center'><img src="apple.svg" alt="" className='w-2/6 max-h-12' /></a>
                            </button>
